...
trait FunSets extends FunSetsInterface {
   ...
   */
//  This is similar as how we define a singleton set:
//  For any y, if there exists an element x in s that satisfies the condition f(x) equals y,
//  then y is in new Set map.
